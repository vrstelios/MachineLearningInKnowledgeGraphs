...
## Σενάριο Χρήσης
 Αυτόματη Πρόβλεψη Βιολογικών Διαδικασιών σε Pathway Data.
- **Στόχος**: Χρήση του DL-Learner για να μάθει κανόνες από δεδομένα BioPAX και να προβλέψει νέες αλληλεπιδράσεις ή να εμπλουτίσει υπάρχουσες οντολογίες.
